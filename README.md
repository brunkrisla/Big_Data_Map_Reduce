...
The aim of this project was to use Hadoop Map Reduce framework to find the descriptive statistics of weather throughout weather stations April 2007. This repossitory contains; the mapper and reduce scripts and the output for each task.The report pdf contains screensshots of the scripts and the outputs as well as the psesudo code.   
